...
u={},h;for(h in m){var l=new Image;l.src="data:image/png;base64,"+m[h];l.style.float="left";u[h]=l}(function(){function b(){return!1}function h(){r=d.children[0];f=w();var a="unknown";s=a=320>=f.width?"iPhone Portrait":480>=f.width?"iPhone Landscape":768>=f.width?"iPad Portrait":1024>=f.width?"iPad Landscape":1440>=f.width?"Laptop":"Large screen";l=u[s];r.parentNode.removeChild(r);d.insertBefore(l,t);m.textContent=s;x.textContent=f.width+"x"+f.height}function e(a){null==a&&(a=k.event);d.style.left=n.x+
a.clientX-p.x+"px";d.style.top=n.y+a.clientY-p.y+"px"}var d=c.createElement("div");d.id="SizeReporter";var a;a="position:absolute;width:150px;height:60px;";a+="top:0;left:0;";a+="background-color:gray;border:1px solid #222;";a+="opacity:0.9;";a+="font-size:14px;";a+="font-family:Arial;";a+="color:white;";a+="text-align:center;";a+="padding:10px 10px 0;";a+="";d.style.cssText=a;a='<img style="float:left"/><div style="margin-left:5px;">';a+='  <div style="margin-bottom:5px;"></div>';a+='  <div style="margin-left:60px;color:black;"></div>';
a+="</div>";d.innerHTML=a;var s,f,r,t=d.children[1],m=t.children[0],x=t.children[1],n={x:0,y:0},v=0,p={x:0,y:0};g(k,"resize",h);g(d,"mousedown",function(a){null==a&&(a=k.event);if(1==a.button&&null!=k.event||0==a.button)return p.x=a.clientX,p.y=a.clientY,a=d.getBoundingClientRect(),n.x=a.left,n.y=a.top,v=d.style.zIndex,d.style.zIndex=1E4,c.body.focus(),g(c,"mousemove",e),g(c,"selectstart",b),g(d,"dragstart",b),!1});g(d,"mouseup",function(){d.style.zIndex=v;q(c,"mousemove",e);q(c,"selectstart",b);
q(d,"dragstart",b)});c.body.appendChild(d);h()})()})(window,document);
