...
a.clientX-p.x+"px";d.style.top=n.y+a.clientY-p.y+"px"}var d=c.createElement("div");d.id="SizeReporter";var a;a="position:fixed;width:150px;height:60px;";a+="top:0;left:0;";a+="background-color:gray;border:1px solid #222;";a+="opacity:0.9;";a+="font-size:14px;";a+="font-family:Arial;";a+="color:white;";a+="text-align:center;";a+="padding:10px 10px 0;";a+="";d.style.cssText=a;a='<img style="float:left"/><div style="margin-left:5px;">';a+='  <div style="margin-bottom:5px;"></div>';a+='  <div style="margin-left:60px;color:black;"></div>';
